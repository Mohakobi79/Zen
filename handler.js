  ...
  try {
    ...
    try {
      ...
      if (chat) {
        ...
        if (!("autogpt" in chat)) chat.chatgpt = false;
    ...
    for (let name in global.plugins) {
      ...
      if ((usedPrefix = (match[0] || "")[0])) {
        ...
        if (plugin.disable && !(isROwner || isOwner)) {
          // Bot number
          fail("disable", m, this);
          continue;
        }
        ...
        if (
          ...
          this.reply(
            m.chat,
            `[❗] Limit harian kamu telah habis, ketik *${usedPrefix}claimlimit* untuk refill\n\natau\nbypass limit dengan berdonasi, ketik *${usedPrefix}donasi*`,
            m
          );
        ...
        for (let user of participants) {
          ...
          try {
            ...
            let lea = await new knights.Goodbye()
              ...
              .setAvatar(pp)
              .setBackground(
                "https://telegra.ph/file/0db212539fe8a014017e3.jpg"
              )
              .toAttachment();
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    private:
      "*PRIVATE CHAT* • COMMAND INI HANYA BISA DIGUNAKAN DI PRIVATE CHAT",
