let handler = async (m, { conn }) => {
  ...
  if (m.sender.startsWith('62') || m.sender.startsWith('+62')) {
    var txt = `
(Indonesian)
**Ketentuan Layanan (TOS) - Zenn MD ESM**
Dengan menggunakan Zenn MD ESM, Anda setuju dengan ketentuan berikut:
...
Dengan menggunakan Zenn MD ESM, Anda setuju dengan semua ketentuan yang berlaku.
...
`
    ...
    txt = `
(English)
**Term of Service (TOS) - Zenn MD ESM**
By using Zenn MD ESM, you agree to the following terms:
...
By using Zenn MD ESM, you agree to abide by all applicable terms.
